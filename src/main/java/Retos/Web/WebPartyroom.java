...
import Retos.Servicio.ServicioPartyroom;
...
public class WebPartyroom {
    ...
    @Autowired
    private ServicioPartyroom servicio;
    @GetMapping("all")
    ...
    @GetMapping("/{id}")
    public Optional<Partyroom> getOrthesis(@PathVariable("id") int idPartyroom) {
        return servicio.getPartyroom(idPartyroom);
    }
    ...
    public boolean delete(@PathVariable("id") int idPartyroom) {
        return servicio.deletePartyroom(idPartyroom);
    }
